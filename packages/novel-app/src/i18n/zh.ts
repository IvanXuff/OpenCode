...
export const dict = {
  ...
  "prompt.placeholder.shell": "输入本地命令... {{example}}",
  "prompt.placeholder.normal": '输入写作要求，例如 "{{example}}"',
  "prompt.placeholder.simple": "输入写作要求，例如：继续写第3章，强化悬疑感，不要水文...",
  "prompt.placeholder.summarizeComments": "总结评论…",
  "prompt.placeholder.summarizeComment": "总结该评论…",
  "prompt.mode.shell": "Shell",
  "prompt.mode.normal": "Prompt",
  "prompt.mode.shell.exit": "按 esc 退出",
  "prompt.example.1": "继续写第3章，先规划再逐场景推进",
  "prompt.example.2": "审稿第2章，找连续性、节奏和人物状态问题",
  ...
  "prompt.example.10": "整理当前账本，指出下一章必须承接的伏笔",
  "prompt.example.11": "把第2章定稿并导出书稿",
  "prompt.example.12": "检查角色有没有提前知道禁忌信息",
  "prompt.example.13": "把当前场景写得更有压迫感",
  "prompt.example.14": "规划第3章，要求结尾留下强钩子",
  "prompt.example.15": "审稿当前章节并给出可执行修复建议",
  "prompt.example.16": "修复当前场景的衔接问题",
  "prompt.example.17": "解释当前章节的伏笔和未解决问题",
  "prompt.example.18": "把当前场景改成更轻小说的节奏",
  "prompt.example.19": "检查账本是否遗漏已定稿事实",
  "prompt.example.20": "列出下一章写作前必须确认的事项",
  "prompt.example.21": "基于上一章全文继续下一章开头",
  "prompt.example.22": "生成本章阶段报告",
  "prompt.example.23": "回收一个已埋下的伏笔",
  "prompt.example.24": "创建一个新场景计划",
  "prompt.example.25": "导出当前小说成品",
  ...
  "session.new.title": "开始写小说",
  "session.new.project.new": "选择小说项目",
  "session.new.project.search": "搜索小说项目",
  "session.new.project.add": "打开小说项目",
