export const dict = {
  ...
  "command.session.new": "New writing session",
  ...
  "prompt.placeholder.shell": "Enter local command... {{example}}",
  "prompt.placeholder.normal": 'Describe what to write, e.g. "{{example}}"',
  "prompt.placeholder.simple": "Describe what to write, e.g. continue chapter 3, heighten suspense, avoid filler...",
  ...
  "prompt.example.1": "Continue chapter 3, plan first then advance scene by scene",
  "prompt.example.2": "Review chapter 2 for continuity, pacing, and character state",
  ...
  "session.new.title": "Write your novel",
  "session.new.project.new": "Select novel project",
  "session.new.project.search": "Search novel projects",
  "session.new.project.add": "Open novel project",
